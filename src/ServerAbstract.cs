...
namespace MyConnection
{
    public abstract class ServerAbstract : IServer
    {
        ...
        public IServer AddModule(IServerModule module)
        {
        ...
        public abstract void OnGetRequest<TResponse>(string subject, Func<IUser, Task<TResponse>> requestLogic)
            where TResponse : IMessage<TResponse>;

        public abstract void OnPostRequest<TRequest, TResponse>(string subject,
            Func<IUser, TRequest, Task<TResponse>> requestLogic) where TRequest : IMessage<TRequest>
            where TResponse : IMessage<TResponse>;
